Ok, mình viết cho bạn một file **README.md** chuẩn cho project Laravel bán hàng thiết bị y tế. Bạn chỉ cần copy vào file `README.md` ở thư mục gốc của project rồi commit/push lên GitHub là được 🚀
